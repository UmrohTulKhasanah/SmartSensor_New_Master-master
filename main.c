...
void print_analogRaw(void){
	...
	_delay_us(500);
	sLow0 = SPI_MasterTransmit(0x03);
	_delay_us(500);
	sHigh0 = SPI_MasterTransmit(0x04);
	_delay_us(500);
	sLow1 = SPI_MasterTransmit(0x05);
	_delay_us(500);
	sHigh1 = SPI_MasterTransmit(0x06);
	_delay_us(500);
	sLow2 = SPI_MasterTransmit(0x07);
	_delay_us(500);
...
void print_calibrateAll(void){
	allCal = SPI_MasterTransmit(0x0E);
	_delay_us(500);
	USART_PutChar(allCal);
}
void print_calibrateAuto(void){
	autoCal = SPI_MasterTransmit(0x0F);
	_delay_us(500);
	USART_PutChar(autoCal);
}
void print_decision(void){
	digital = SPI_MasterTransmit(0x01);
	_delay_us(500);
